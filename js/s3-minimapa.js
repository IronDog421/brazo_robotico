...
function loadScene() {
    ...
    playerIcon = new THREE.Mesh(new THREE.SphereGeometry(7, 3, 3), iconMat);
...
function update()
{
    ...
    let velocity = new THREE.Vector3(Math.sin(angulo), 0, Math.cos(angulo)); // Vector unitario en la dirección del ángulo
    ...
    playerIcon.position.set(p_pos.x, p_pos.y, p_pos.z);
    lookAt = new THREE.Vector3().addVectors(p_pos, velocity.multiplyScalar(25))
    playerIcon.lookAt(lookAt);
